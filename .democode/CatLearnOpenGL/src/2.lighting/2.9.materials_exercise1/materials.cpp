...
int main()
{
    ...
    // 构建并编译着色器z程序
    // ------------------------------------
    Shader lightingShader("2.9.materials.vs", "2.9.materials.fs");
    Shader lightCubeShader("2.9.light_cube.vs", "2.9.light_cube.fs");
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        lightingShader.setFloat("material.shininess", 0.3f);
