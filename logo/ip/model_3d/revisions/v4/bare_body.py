...
ARM_PROFILE = [
    ...
    (.760, .900, -.025, .136, .187),
    (.920, .900, -.010, .149, .200),
    (1.060, .852, .010, .170, .210),
    (1.180, .754, .020, .200, .226),
    (1.320, .592, .025, .215, .218),
    (1.460, .414, .028, .165, .180),
...
def build_body(*, mesh, curve, ellipsoid, patch, ring_mesh, interpolate,
    ...
    return {
        'revision': 'v4 fuller taller body with free arm inner edges',
        ...
        'arm_attachment': 'Shoulders only; visible gap along forearms and lower upper arms',
        'belly': {
