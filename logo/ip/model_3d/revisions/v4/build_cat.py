...
ear_revision=build_ears(mesh=mesh,closed_catmull=closed_catmull,fur=fur,pink=pink)
...
root['revision']='v4: fuller body, free arms, rounded ears; preserved v3 head and face'
...
cams={
    ...
    'ear':camera('Camera • Soft ear detail',(6,-8,6),(1.60,.24,4.0+HEAD_LIFT),1.12),
...
for name in (() if BUILD_ONLY else ('front','side','back','hero','body','face_side','rear_quarter','ear')):
