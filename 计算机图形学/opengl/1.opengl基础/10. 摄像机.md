...
![camera_axes](../../../resource/计算机图形学/camera_axes.png)
...
$$LookAt = \begin{bmatrix} \textcolor{red}{R_x \ R_y \ R_z} \ 0 \\ \textcolor{green}{U_x \ U_y \ U_z} \ 0 \\ \textcolor{blue}{D_x \ D_y \ D_z} \ 0 \\ 0 \ 0 \ 0 \ 1 \end{bmatrix} * \begin{bmatrix}  1 \ 0 \ 0 \ \ \ -\textcolor{#800080}{P_x} \\ 0 \ 1 \ 0 \ \ \ -\textcolor{#800080}{P_y} \\ 0 \ 0 \ 1 \ \ \ -\textcolor{#800080}{P_z} \\ 0 \ 0 \ 0 \ \ \ 1 \end{bmatrix}$$
...
通过这一小段代码，摄像机现在会随着时间流逝围绕场景转动了。自己试试改变半径和位置/方向参数，看看**LookAt**矩阵是如何工作的。
...
![camera_pitch_yaw_roll](../../../resource/计算机图形学/camera_pitch_yaw_roll.png)
...
![camera_triangle](../../../resource/计算机图形学/camera_triangle.png)

如果我们把斜边边长定义为1，我们就能知道邻边的长度是$cos \textcolor{red}{x}/\textcolor{#800080}{h}=cos \textcolor{red}{x}/\textcolor{#800080}{1}=cos \textcolor{red}{x}$，它的对边是$sin \textcolor{#008000}{y}/\textcolor{#800080}{h}=sin \textcolor{#008000}{y}/\textcolor{#800080}{1}=sin \textcolor{#008000}{y}$。这样我们获得了能够得到x和y方向长度的通用公式，它们取决于所给的角度。我们使用它来计算方向向量的分量：
![camera_pitch](../../../resource/计算机图形学/camera_pitch.png)
...
![camera_yaw](../../../resource/计算机图形学/camera_yaw.png)
