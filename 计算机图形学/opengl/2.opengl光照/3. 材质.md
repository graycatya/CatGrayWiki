...
![materials_with_material](../../../resource/计算机图形学/materials_with_material.png)
...
![materials_light](../../../resource/计算机图形学/materials_light.png)
...
[materials.mp4](https://learnopengl-cn.github.io/img/02/03/materials.mp4)

你可以看到，不同的光照颜色能够极大地影响物体的最终颜色输出。由于光照颜色能够直接影响物体能够反射的颜色（回想[颜色](https://learnopengl-cn.github.io/02%20Lighting/01%20Colors/)这一节），这对视觉输出有着显著的影响。
