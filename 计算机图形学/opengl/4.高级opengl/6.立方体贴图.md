...
同样，我们有一个观察向量$\textcolor{gray}{\overline{I}}$，一个法向量$\textcolor{red}{\overline{N}}$，而这次是折射向量$\textcolor{green}{\overline{R}}$。可以看到，观察向量的方向轻微弯曲了。弯折后的向量$\textcolor{green}{\overline{R}}$

将会用来从立方体贴图中采样。

折射可以使用GLSL的内建$\textcolor{brown}{refract}$函数来轻松实现，它需要一个法向量、一个观察方向和两个材质之间的折射率(Refractive Index)。
...
![cubemaps_refraction_backpack](../../../resource/计算机图形学/cubemaps_refraction_backpack.png)
