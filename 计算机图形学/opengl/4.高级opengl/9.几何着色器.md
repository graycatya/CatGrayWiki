...
![geometry_shader_points](../../../resource/计算机图形学/geometry_shader_points.png)
...
![geometry_shader_triangle_strip](../../../resource/计算机图形学/geometry_shader_triangle_strip.png)

通过使用三角形带作为几何着色器的输出，我们可以很容易创建出需要的房子形状，只需要以正确的顺序生成3个相连的三角形就行了。下面这幅图展示了顶点绘制的顺序，蓝点代表的是输入点：

![geometry_shader_house](../../../resource/计算机图形学/geometry_shader_house.png)
...
![geometry_shader_houses](../../../resource/计算机图形学/geometry_shader_houses.png)
...
如果顶点着色器发送的颜色向量是out vec3 vColor，那这么写就没问题。然而，接口块在几何着色器这样的着色器中会更容易处理一点。实际上，几何着色器的输入能够变得非常大，将它们合并为一个大的接口块数组会更符合逻辑一点。
...
![geometry_shader_houses_colored](../../../resource/计算机图形学/geometry_shader_houses_colored.png)
...
![geometry_shader_houses_snow](../../../resource/计算机图形学/geometry_shader_houses_snow.png)
...
![geometry_shader_explosion_backpack](../../../resource/计算机图形学/geometry_shader_explosion_backpack.png)
...
![geometry_shader_normals_backpack](../../../resource/计算机图形学/geometry_shader_normals_backpack.png)
