...
这个lightSpaceMatrix正是前面我们称为T的那个变换矩阵。有了lightSpaceMatrix只要给shader提供光空间的投影和视图矩阵，我们就能像往常那样渲染场景了。然而，我们只关心深度值，并非所有片段计算都在我们的着色器中进行。为了提升性能，我们将使用一个与之不同但更为简单的着色器来渲染出深度贴图。
...
![shadow_mapping_depth_map](../../../../resource/计算机图形学/shadow_mapping_depth_map.png)
...
![shadow_mapping_shadows](../../../../resource/计算机图形学/shadow_mapping_shadows.png)
...
![shadow_mapping_acne](../../../../resource/计算机图形学/shadow_mapping_acne.png)

我们可以看到地板四边形渲染出很大一块交替黑线。这种阴影贴图的不真实感叫做阴影失真(Shadow Acne)，下图解释了成因：

![shadow_mapping_acne_diagram](../../../../resource/计算机图形学/shadow_mapping_acne_diagram.png)
...
![shadow_mapping_acne_bias](../../../../resource/计算机图形学/shadow_mapping_acne_bias.png)
...
![shadow_mapping_with_bias](../../../../resource/计算机图形学/shadow_mapping_with_bias.png)
...
![shadow_mapping_peter_panning](../../../../resource/计算机图形学/shadow_mapping_peter_panning.png)
...
![shadow_mapping_culling](../../../../resource/计算机图形学/shadow_mapping_culling.png)
...
![shadow_mapping_outside_frustum](../../../../resource/计算机图形学/shadow_mapping_outside_frustum.png)
...
![shadow_mapping_clamp_edge](../../../../resource/计算机图形学/shadow_mapping_clamp_edge.png)
...
![shadow_mapping_over_sampling_fixed](../../../../resource/计算机图形学/shadow_mapping_over_sampling_fixed.png)
...
![shadow_mapping_zoom](../../../../resource/计算机图形学/shadow_mapping_zoom.png)
...
![shadow_mapping_soft_shadows](../../../../resource/计算机图形学/shadow_mapping_soft_shadows.png)

从稍微远一点的距离看去，阴影效果好多了，也不那么生硬了。如果你放大，仍会看到阴影贴图分辨率的不真实感，但通常对于大多数应用来说效果已经很好了。

你可以从这里找到这个例子的全部源码和第二个阶段的顶点和片段着色器。
...
![shadow_mapping_projection](../../../../resource/计算机图形学/shadow_mapping_projection.png)
