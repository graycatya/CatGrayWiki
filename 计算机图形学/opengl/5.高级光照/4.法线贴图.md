...
$$\begin{bmatrix} T_x & T_y & T_z \\ B_x & B_y & B_z \end{bmatrix} = \frac{1}{ΔU_1 ΔV_2 - ΔU_2 ΔV_1}  \begin{bmatrix} ΔV_2 & -ΔV_1 \\ -ΔU_2 & ΔU_1 \end{bmatrix} \begin{bmatrix} E_{1x} & E_{1y} & E_{1z} \\ E_{2x} & E_{2y} & E_{2z} \end{bmatrix}$$
...
<span style="color:#0088ff;">手工计算切线和副切线</span>
...
[...] //类似的程序计算平面的第二个三角形的 tangent/bitangent
```
...
![normal_mapping_tbn_shown](../../../resource/计算机图形学/normal_mapping_tbn_shown.png)

每个顶点定义了切线和副切线向量，我们就可以开始实现正确的法线贴图了。


<span style="color:#0088ff;">切线空间法线贴图</span>
...
![normal_mapping_correct_tangent](../../../resource/计算机图形学/normal_mapping_correct_tangent.png)

<span style="color:#0088ff;">复杂物体</span>
...
![normal_mapping_complex_compare](../../../resource/计算机图形学/normal_mapping_complex_compare.png)
...
![normal_mapping_comparison](../../../resource/计算机图形学/normal_mapping_comparison.png)
