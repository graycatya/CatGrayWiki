...
![](../../../resource/计算机图形学/deferred_example.png)
...
![](../../../resource/计算机图形学/deferred_g_buffer.png)
...
![](../../../resource/计算机图形学/deferred_overview.png)
...
对于每一个片段我们需要储存的数据有：一个**位置**向量、一个**法**向量，一个**颜色**向量，一个镜面强度值。所以我们在几何处理阶段中需要渲染场景中所有的对象并储存这些数据分量到G缓冲中。我们可以再次使用**多渲染目标(Multiple Render Targets)**来在一个渲染处理之内渲染多个颜色缓冲，在之前的[泛光教程](https://learnopengl-cn.github.io/05%20Advanced%20Lighting/07%20Bloom/)中我们也简单地提及了它。
...
![](../../../resource/计算机图形学/deferred_shading.png)
...
![](../../../resource/计算机图形学/deferred_lights_no_depth.png)
...
![](../../../resource/计算机图形学/deferred_lights_depth.png)
...
![](../../../resource/计算机图形学/deferred_light_volume_rendered.png)
