...
![fire](../../../../resource/计算机图形学/particles_example.jpg)
...
[视频：particles.mp4](../../../../resource/计算机图形学/particles.mp4)
...
然后在游戏代码里,我们创建这样一个粒子发射器并且用[这个](https://learnopengl-cn.github.io/img/06/Breakout/06/particle.png/)纹理初始化。
