...
> **重要：** 
> 这章教程广泛运用了之前[帧缓冲](https://learnopengl-cn.github.io/04%20Advanced%20OpenGL/05%20Framebuffers/)与[抗锯齿](https://learnopengl-cn.github.io/04%20Advanced%20OpenGL/11%20Anti%20Aliasing/)章节的概念。
...
![](../../../../resource/计算机图形学/postprocessing_effects.png)
...
[视频演示](https://learnopengl.com/video/in-practice/breakout/postprocessing_shake.mp4)

你可以在[这里](https://learnopengl.com/code_viewer.php?code=in-practice/breakout/game_postprocessing)找到更新后的Game类。

在[下一章](https://learnopengl-cn.github.io/06%20In%20Practice/2D-Game/08%20Powerups/)关于“道具”的教程中我们将带来另外两种的特效的使用。
