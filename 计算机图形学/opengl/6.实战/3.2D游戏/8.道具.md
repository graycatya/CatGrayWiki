...
void Game::UpdatePowerUps(GLfloat dt)
{
    ...
    this->PowerUps.erase(std::remove_if(this->PowerUps.begin(), this->PowerUps.end(),
        [](https://learnopengl-cn.github.io/06%20In%20Practice/2D-Game/const%20PowerUp%20%26powerUp/) { return powerUp.Destroyed && !powerUp.Activated; }
    ), this->PowerUps.end());
}  
```
...
[视频演示](https://learnopengl.com/video/in-practice/breakout/powerups.mp4)
