...
![](../../../../resource/计算机图形学/ibl_hemisphere_sample.png)

这个预计算的立方体贴图，在每个采样方向 $w_o$ 上存储其积分结果，可以理解为场景中所有能够击中面向 $w_o$ 的表面的间接漫反射光的预计算总和。这样的立方体贴图被称为辐照度图，因为经过卷积计算的立方体贴图能让我们从任何方向有效地直接采样场景（预计算好的）辐照度。
...
![](../../../../resource/计算机图形学/ibl_irradiance.png)
...
![](../../../../resource/计算机图形学/ibl_hdr_radiance.png)
...
![](../../../../resource/计算机图形学/ibl_equirectangular_projection.png)
...
![](../../../../resource/计算机图形学/ibl_hdr_environment_mapped.png)
...
![](../../../../resource/计算机图形学/ibl_hemisphere_sample_normal.png)
...
![](../../../../resource/计算机图形学/ibl_spherical_integrate.png)
...
![](../../../../resource/计算机图形学/ibl_irradiance_map_background.png)
...
![](../../../../resource/计算机图形学/lighting_fresnel_no_roughness.png)
...
![](../../../../resource/计算机图形学/ibl_irradiance_result.png)
